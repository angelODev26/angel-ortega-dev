...
const messages = {
  es: {
    ...
    profile: {
      ...
      description: "Desarrollador Backend con 7+ años especializado en APIs REST, microservicios y optimización de bases de datos. He escalado procesamiento de datos de 30,000 a 150,000 registros por minuto.",
      technologies: "Tecnologías Principales",
      techList: ["PHP/Laravel", "MySQL/PostgreSQL", "MongoDB", "Redis", "Docker", "AWS", "Java/Spring Boot", "Vue.js"],
      contact: "Contacto"
    },
    hero: {
      greeting: "¡Hola! Soy",
    ...
    specialization: {
      ...
      content: "APIs REST, Microservicios, Optimización de Bases de Datos, Procesamiento Masivo de Datos"
    },
    achievement: {
      title: "Logro Destacado",
      content: "Escalé el procesamiento de registros de 30,000/h a 150,000 registros por minuto optimizando MongoDB y lógica de jobs"
    },
    technologies: {
      ...
      jobs: [
        {
          ...
          description: "Desarrollo y optimización de aplicaciones Laravel, manejo de bases de datos MySQL/MongoDB, implementación de colas con Redis/SQS.",
        ...
        },
        {
          ...
          description: "Desarrollo full-stack con PHP, PostgreSQL y JavaScript. Optimización de consultas y administración de servidores.",
        ...
        },
        {
          ...
          description: "Desarrollo full-stack con PHP, Vue.js y PostgreSQL. Gestión de bases de datos y optimización de rendimiento.",
        ...
        },
        {
          ...
          description: "Desarrollo full-stack en Java, PHP y MySQL. Desarrollo de app Android nativa para gestión de pedidos.",
      ...
      achievementsList: [
        {
          ...
          description: "Escalé el procesamiento de datos de 30,000 a 150,000 registros por minuto mediante optimización de MongoDB y implementación de colas."
        },
        {
          title: "Arquitectura de Microservicios",
          description: "Diseñé e implementé una arquitectura de microservicios que mejoró la escalabilidad y mantenibilidad del sistema."
        },
        {
          title: "Seguridad y Performance",
          description: "Corregí vulnerabilidades de SQL Injection y optimicé consultas reduciendo tiempos de respuesta en 70%."
        }
      ]
    },
    projects: {
  ...
  en: {
    ...
    profile: {
      name: "Angel Ortega",
      title: "Backend Developer Expert - PHP/Laravel",
      description: "Backend Developer with 7+ years specialized in REST APIs, microservices and database optimization. I've scaled data processing from 30,000 to 150,000 records per minute.",
    ...
    achievement: {
      ...
      content: "Scaled record processing from 30,000/h to 150,000 records per minute by optimizing MongoDB and job logic"
    },
    technologies: {
      title: "Tech Stack"
    },
      ...
      jobs: [
        {
          ...
          description: "Development and optimization of Laravel applications, MySQL/MongoDB database management, queue implementation with Redis/SQS.",
          technologies: ["Laravel", "MongoDB", "Redis", "Docker", "SQS"],
          achievements: [
        ...
        },
        {
          ...
          description: "Full-stack development with PHP, PostgreSQL and JavaScript. Query optimization and server administration.",
          technologies: ["PHP", "PostgreSQL", "JavaScript", "jQuery"],
          achievements: [
        ...
        },
        {
          ...
          description: "Full-stack development with PHP, Vue.js and PostgreSQL. Database management and performance optimization.",
          technologies: ["PHP", "Vue.js", "PostgreSQL", "Bootstrap"],
          achievements: [
        ...
        },
        {
          ...
          description: "Full-stack development in Java, PHP and MySQL. Native Android app development for order management.",
          technologies: ["Java", "PHP", "MySQL", "Android"],
          achievements: [
            "Native Android app development",
            "REST APIs implementation for mobile"
          ]
        }
      ],
      achievementsList: [
        {
          ...
          description: "Scaled data processing from 30,000 to 150,000 records per minute through MongoDB optimization and queue implementation."
        },
        {
          title: "Microservices Architecture",
          description: "Designed and implemented a microservices architecture that improved system scalability and maintainability."
        },
        {
          title: "Security and Performance",
          description: "Fixed SQL Injection vulnerabilities and optimized queries reducing response times by 70%."
        }
      ]
    },
    projects: {
