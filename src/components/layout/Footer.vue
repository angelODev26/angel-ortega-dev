<template>
  <footer class="main-footer">
    <div class="footer-content">
      <p>&copy; {{ new Date().getFullYear() }} {{ $t('footer.copyright', { year: new Date().getFullYear() }) }}</p>

      <div class="social-links">
        <a href="https://github.com/angelODev26" target="_blank" rel="noopener" class="social-link">
        ...
        <a href="https://linkedin.com/in/devangelob" target="_blank" rel="noopener" class="social-link">
          <svg class="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            <path
